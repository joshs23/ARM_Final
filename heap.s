...
_ralloc
	;; Helper function for _kalloc
		...
		CMP		r0, r9 			; if(size needed <= act_half_size)
		BGT		_else			; branch to 
...
_else
		...
		LSL		r1, r1, #0x4 	; (left - mcb_top) * 16 = offset
		ADD		r11, r11, r1	; offset is added to start in mem
		MOV		r12, r11		; address of stored mem is saved to return
...
_alloc
		...
		POP		{lr}
		MOV		R0, R12				; move the address allocated to r0 to return
